...
"""autogenerated by genpy from bluerov2_control/FollowWaypointsGoal.msg. Do not edit."""
import codecs
import sys
...
class FollowWaypointsGoal(genpy.Message):
  _md5sum = "58e5d76705941fad7db4292f7d5be15d"
  _type = "bluerov2_control/FollowWaypointsGoal"
...
"""
  __slots__ = ['waypoints']
  _slot_types = ['uuv_control_msgs/WaypointSet']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.waypoints is None:
        self.waypoints = uuv_control_msgs.msg.WaypointSet()
    else:
      self.waypoints = uuv_control_msgs.msg.WaypointSet()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2I().pack(_x.waypoints.start_time.data.secs, _x.waypoints.start_time.data.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.waypoints.start_time.data.secs, _x.waypoints.start_time.data.nsecs,) = _get_struct_2I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
