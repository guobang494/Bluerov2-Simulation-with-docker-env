...
echo_and_run cd "/root/catkin_ws/eight-thurster/src/bluerov2/bluerov2_control"
...
echo_and_run /usr/bin/env \
    ...
    "/root/catkin_ws/eight-thurster/src/bluerov2/bluerov2_control/setup.py" \
     \
    build --build-base "/root/catkin_ws/eight-thurster/build/bluerov2/bluerov2_control" \
    install \
    --root="${DESTDIR-/}" \
