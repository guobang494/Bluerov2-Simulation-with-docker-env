...
echo_and_run cd "/root/catkin_ws/eight-thurster/src/uuv_simulator/uuv_assistants"
...
echo_and_run /usr/bin/env \
    ...
    "/root/catkin_ws/eight-thurster/src/uuv_simulator/uuv_assistants/setup.py" \
     \
    build --build-base "/root/catkin_ws/eight-thurster/build/uuv_simulator/uuv_assistants" \
    install \
    --root="${DESTDIR-/}" \
