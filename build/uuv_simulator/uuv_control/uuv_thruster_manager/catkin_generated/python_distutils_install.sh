...
echo_and_run cd "/root/catkin_ws/eight-thurster/src/uuv_simulator/uuv_control/uuv_thruster_manager"
...
echo_and_run /usr/bin/env \
    ...
    "/root/catkin_ws/eight-thurster/src/uuv_simulator/uuv_control/uuv_thruster_manager/setup.py" \
     \
    build --build-base "/root/catkin_ws/eight-thurster/build/uuv_simulator/uuv_control/uuv_thruster_manager" \
    install \
    --root="${DESTDIR-/}" \
