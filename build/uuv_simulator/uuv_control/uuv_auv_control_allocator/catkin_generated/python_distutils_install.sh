...
echo_and_run cd "/root/catkin_ws/eight-thurster/src/uuv_simulator/uuv_control/uuv_auv_control_allocator"
...
echo_and_run /usr/bin/env \
    ...
    "/root/catkin_ws/eight-thurster/src/uuv_simulator/uuv_control/uuv_auv_control_allocator/setup.py" \
     \
    build --build-base "/root/catkin_ws/eight-thurster/build/uuv_simulator/uuv_control/uuv_auv_control_allocator" \
    install \
    --root="${DESTDIR-/}" \
